  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-slate-950 z-0">
        ...
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#D4AF37]/5 rounded-full blur-3xl mix-blend-screen"></div>
        <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-blue-900/10 rounded-full blur-3xl mix-blend-screen"></div>
      </div>
