...
const Hero = () => {
  return (
    ...
    >
      {/* Premium Globe Background Image */}
      <div className="absolute inset-0 z-0 bg-[#020818]">
        <img
          src="/hero-globe.png"
          alt=""
          aria-hidden="true"
        ...
        />
        {/* Fades from solid dark at top (text area) to transparent at center, then fully transparent at bottom so globe is visible */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#020818] via-[#020818]/60 to-transparent"></div>
        {/* Bottom-to-center fade to blend the globe bottom edge into the page */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#020818] via-[#020818]/50 to-transparent"></div>
      </div>
